...
If you think you have found a vulnerability in this repository, please
...
* Contact the [Eclipse Foundation Security Team]
	(mailto:security@eclipse-foundation.org) via email
...
* Report a [vulnerability]
	(https://github.com/jakartaee/agentic-ai/security/advisories/new)
...
Please include as much of the information listed below as you can to help
us better understand and resolve the issue:
